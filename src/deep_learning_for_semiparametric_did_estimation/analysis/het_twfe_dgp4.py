...
def het_twfe_DGP4_simulation():
    ...
    for _i in range(1000):
        ...
        # List of independent variables for the third model
        ...
        twfe_het = twfe_het_i.params["post:d"]
    ...
    # Calculate metrics for the standard TWFE model
    avg_bias = np.mean(
        ATTE_estimates - 0
    ...
    # Calculate metrics for the corrected TWFE model
    ...
    # Calculate metrics for the third model accounting for heterogeneous effects
